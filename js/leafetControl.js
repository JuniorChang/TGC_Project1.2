...
// A layer control for layer groupings.
L.Control.GroupedLayers = L.Control.extend({
    ...
    _addItem: function (obj) {
      ...
      if (obj.overlay) {
        ...
        // Creating the group container if it doesnt exist
        if (!groupContainer) {
          ...
          if (obj.group.name !== '' && !obj.group.exclusive) {
            // adding a group checkbox with an _onInputClickGroup function
    ...
    _expand: function () {
      ...
      // allow the scrollbar if overlays heighter than the map.
